	...
	class Page2CatAdmin extends Page2Cat_Core{
		...
		static function add_meta_boxes(){
			if ( !defined( 'SWER_PHPUNIT' ) )
				add_meta_box(
					...
					array( 'Page2CatAdmin', 'page2cat_custom_metabox' ), 
					'page', 
					'side', 
					'core'
				);        
		...
		static function admin_init() {
			add_settings_section(
				...
				array( 'Page2CatAdmin', 'settings_section' ), 
				'reading'
			);
			add_settings_field(
				'p2c_list_thumb', 
				'[showlist] thumbnail size',
				array( 'Page2CatAdmin', 'field_p2c_list_thumb' ),
				'reading',
				'page2cat',
				array( 'label_for' => 'p2c_list_thumb' )
			);
			register_setting(
				'reading',
				'p2c_list_thumb',
				array( 'Page2CatAdmin', 'validate_settings' )
			);
		}
